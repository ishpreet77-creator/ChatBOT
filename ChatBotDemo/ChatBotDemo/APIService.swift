...
class APIService {
    ...
    let apiKey = "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"
    ...
    func sendPromtToGpt(promt: String) async throws -> String{
        ...
        var urlRequest = try await  createURLRequestFor(httpMethod: "POST", url: completion, prompt: promt, isDalE: false)
